            ...
            <li v-for="command in commands" :key="command.id" class="command-list-item">
                <div class="relative">
                    <div class="w-full flex justify-end absolute edit-link">
                        <Link :href="route('command.edit', { id: command.id })" class="p-2 text-xs font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
