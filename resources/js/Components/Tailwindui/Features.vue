...
const features = [
    {
        name: "Easy workflow integration",
        description: "Easy to use CLI application that provides you with intuitive search functionality.",
        icon: GlobeAltIcon,
    },
    {
        name: "Free of charge",
        description: "No limit on the number of projects and commands that you store.",
        icon: ScaleIcon,
    },
    {
        name: "Share with the team",
        description: "Everyone can simple add you to their list of team members and can access your commands instantly.",
        icon: BoltIcon,
    },
    {
        name: "Future updates to the platform",
        description: "Future updates will bring a lot of useful commands right in your dashboard by default.",
