            ...
            <div class="-mx-4 flex flex-wrap lg:justify-between">
                    ...
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                      <span class="text-primary mb-4 block text-base font-semibold">
                        ...
                        <p class="text-body-color mb-9 text-base leading-relaxed">
                            ...
                            You can contact us through our website's form, or by email at rok.zabukovec.it@gmail.com or by phone at +386 40 262 866.
                            We look forward to speaking with you and discussing how we can assist you.
                        </p>
              ...
              ></textarea>
                            ...
                            <div>
                                <button
                                    type="submit"
                                    class="bg-indigo-600 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                                >
                                    Send Message
                                </button>
                            </div>
