                    ...
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        ...
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-base">Šolska ulica 18, 8340 Črnomelj</p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-base">+386 40 262 866</p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-base">rok.zabukovec.it@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                        <form @submit.prevent="saveContact">
                            <div class="mb-6">
                                <input v-model="form.name" type="text" placeholder="Your Name" class="text-body-color border-[f0f0f0] focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none" required />
                            </div>
                            <div class="mb-6">
                                <input v-model="form.email" type="email" placeholder="Your Email" class="text-body-color border-[f0f0f0] focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none" required />
                            </div>
                            <div class="mb-6">
                                <textarea v-model="form.description" rows="6" placeholder="Your Message" class="text-body-color border-[f0f0f0] focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none" required></textarea>
                            </div>
                            <div>
                                <button type="submit" class="bg-indigo-600 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90">Send Message</button>
                            </div>
                        </form>
                        <div>
...
function saveContact() {
    axios
        ...
        .then((response) => {
            toast.success("Your email was added as a contact.", {
                timeout: 2000,
            });
        ...
        .catch((error) => {
            toast.Error("The email has already been entered.", {
                timeout: 2000,
            });
        });
}
