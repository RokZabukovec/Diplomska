                                    ...
                                    <form class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                        <div class="flex-1">
                                            ...
                                            <div class="bg-gray-50 px-4 py-6 sm:px-6">
                                                <div class="flex items-start justify-between space-x-3">
                                                    <div class="space-y-1">
                                                        <DialogTitle class="text-lg font-medium text-gray-900">Link </DialogTitle>
                                                    </div>
                                            ...
                                            <div class="space-y-6 py-6 sm:space-y-0 sm:divide-y sm:divide-gray-200 sm:py-0">
                                                ...
                                                <div class="space-y-1 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                                                    <div>
                                                        <label class="block text-sm font-medium text-gray-900 sm:mt-px sm:pt-2" for="project-name">Title</label>
                                                    </div>
                                                    <div class="sm:col-span-2">
                                                        <input id="title" v-model="form.title" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" name="link-title" type="text" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="space-y-6 py-6 sm:space-y-0 sm:divide-y sm:divide-gray-200 sm:py-0">
                                                    <!-- url -->
                                                    <div class="space-y-1 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                                                        <label class="block text-sm font-medium text-gray-700" for="company-website">URL</label>
                                                        <div class="sm:col-span-2">
                                                            <div class="relative mt-1 rounded-md shadow-sm">
                                                                <input id="url" v-model="form.url" class="block w-full rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" name="url" placeholder="www.example.com" type="url" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="flex-shrink-0 px-4 py-5 sm:px-6">
                                            <div class="flex justify-end space-x-3">
                                                ...
                                                <button class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" type="submit" @click.prevent="storeLink">Create</button>
                                            </div>
                                        </div>
                                    </form>
                                </DialogPanel>
...
onMounted(() => {
    store.commit("links/getLinks", projectId);
});

function storeLink() {
    store.commit("links/storeLink", form);
    open.value = false;
