            ...
            <div class="flex h-16 justify-between">
                <div class="flex">
                    ...
                    <div class="hidden md:ml-6 md:flex md:space-x-8">
                        ...
                        <Link href="#" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700 font-semibold">Statistics</Link>
                    </div>
                </div>
                        ...
                        <Menu as="div" class="relative ml-3">
                            ...
                            <transition enter-active-class="transition ease-out duration-200" enter-from-class="transform opacity-0 scale-95" enter-to-class="transform opacity-100 scale-100" leave-active-class="transition ease-in duration-75" leave-from-class="transform opacity-100 scale-100" leave-to-class="transform opacity-0 scale-95">
                                <MenuItems class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                    ...
                                    <MenuItem v-slot="{ active }">
                                        <a :href="route('profile.show')" :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700 bold']" @click.prevent="Inertia.post(route('logout'))">Sign out</a>
                                    </MenuItem>
                                </MenuItems>
                            </transition>
                        </Menu>
