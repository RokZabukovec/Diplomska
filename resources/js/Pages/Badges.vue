...
function remove(name) {
    searchStore.dispatch('search/removeBadge', name);
}

</script>

<template>
  <span v-for="badge in badges" :key="badge" class="inline-flex items-center gap-x-0.5 rounded-md bg-orange-100 px-2 py-1 text-xs font-medium text-gray-600">
    {{ badge }}
