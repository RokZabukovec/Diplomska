<template>
    <div
        class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 prose prose-stone"
    >
        <div class="max-w-xl mb-5 md:mx-auto lg:max-w-2xl">
            <div class="mb-1 text-center">
                <h1 class="text-indigo-600">{{ page.title }}</h1>
                <small
                    class="mb-2 text-xs font-semibold text-center tracking-wide text-gray-400 sm:text-center"
                >
