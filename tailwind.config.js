...
module.exports = {
    ...
    plugins: [require("@tailwindcss/forms"), require("@tailwindcss/typography"), require("tailwindcss-font-inter"), require("@tailwindcss/typography"), require("@tailwindcss/line-clamp")],
};
